...
par(mar = c(1, 1, 2, 1))
plot(0, 0, type = "n", xlim = c(0, 10), ylim = c(0, 4), axes = FALSE,
...
- **[Communication Analysis](04-communication.html)**: How to combine production and sensing
- **[Visualization](05-visualization.html)**: Advanced plotting options
