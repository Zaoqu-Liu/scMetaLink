...
```{r flowchart, echo=FALSE, out.width="100%", fig.cap="**Figure 1: scMetaLink Workflow.** Schematic overview of the analysis pipeline for inferring metabolite-mediated cell-cell communication."}
...
```{r calflow, echo=FALSE, out.width="100%", fig.cap="**Figure 2: Computational Algorithm.** Schematic illustration of the mathematical framework for computing metabolite production, sensing, and communication scores."}
knitr::include_graphics("calflow.png")
```
...
For more advanced tutorials, visit our website:

- **[Production & Sensing Analysis](https://Zaoqu-Liu.github.io/scMetaLink/articles/production-sensing.html)**: Detailed parameter tuning
- **[Communication Analysis](https://Zaoqu-Liu.github.io/scMetaLink/articles/communication.html)**: Advanced communication analysis
- **[Spatial Analysis](https://Zaoqu-Liu.github.io/scMetaLink/articles/spatial-analysis.html)**: Spatial transcriptomics support
