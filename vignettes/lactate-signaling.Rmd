...
if (!is.null(lactate_results)) {
  prod_scores <- lactate_results$production_scores
...
if (!is.null(lactate_results)) {
  direct_sens <- lactate_results$direct_sensing_scores
  indirect_sens <- lactate_results$indirect_sensing_scores
...
if (!is.null(lactate_results) && !is.null(lactate_results$communication)) {
...
if (!is.null(lactate_results) && !is.null(lactate_results$communication)) {
  comm <- lactate_results$communication$combined
